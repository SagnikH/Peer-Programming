		...
		<div>
			<div className={styles.peer}>
				<div className={styles.peerDesc}>
					...
					<div className={styles.peerDescText}>
						...
						Enabled Collaborative Code Editor Platform ! Now you can video chat
						and collaborate on code simultaneously on the same window, without
						any hassle or the requirement of a different software. Whether it's
						about brainstorming over a leetcode problem with peers, practising
						mock interviews with seniors, or even recording a problem
						explanation by yourself, Peer-Programming is your go-to for all your
						collaborative coding needs !
					</div>
				</div>
				<img className={styles.peerImage} src={favicon} />
			</div>
			...
			<div className={styles.person}>
				<div className={styles.personDesc}>
					...
					<div className={styles.shortPersonDesc}>
						...
						Hands on experience in Html, Css, Javascript, React, NodeJs, Git,
				...
				<div>
					<img className={styles.personImage} src={sattam} />
				</div>
			</div>
			<div className={styles.person}>
				<div>
					<img className={styles.personImage} src={sagnik} />
				</div>
				<div className={styles.personDesc}>
					<div className={styles.nameTitle}>Sagnik Haldar</div>
					<div className={styles.shortPersonDesc}>
						Pursuing B.E. in Information Technology at Jadavpur University. I am
						a full stack web developer. Experienced in working with MERN technologies.
						<br />
						<br />
			...
			<div className={styles.person}>
				<div className={styles.personDesc}>
					...
					<div className={styles.shortPersonDesc}>
						I am an Undergrad studying B.E. on Information Technology at
						Jadavpur University. I am an Open Source and upcoming Web
						Techonologies enthusiast, experienced in C, C++, TypeScript.
					</div>
					<div className="d-flex w-50 justify-content-around">
						<a
							className={styles.btn}
				...
				<div>
					<img className={styles.personImage} src={ronak} />
				</div>
			</div>
			<div className={styles.person}>
				<div>
					<img className={styles.personImage} src={subodh} />
				</div>
				<div className={styles.personDesc}>
